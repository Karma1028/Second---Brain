  ...
  return (
    <div className="flex-1 flex flex-col relative">
      ...
      <header className="flex items-center justify-between px-8 py-6 z-10 shrink-0">
        <div>
          <h2 className="text-3xl font-black tracking-tight text-white mb-1 font-display">Cognitive Analytics</h2>
          <p className="text-slate-400 text-sm">Biometrics & Productivity Correlation Analysis</p>
        </div>
        <div className="flex items-center gap-4 bg-surface-dark border border-white/5 p-1 rounded-xl">
          <button className="px-4 py-1.5 text-xs font-medium text-white bg-primary/20 rounded-lg border border-primary/20 shadow-sm transition-all hover:bg-primary/30">Today</button>
          ...
          <button className="px-4 py-1.5 text-xs font-medium text-slate-400 hover:text-white transition-colors">All</button>
        </div>
      </header>
      ...
      <div className="flex-1 overflow-y-auto px-8 pb-8 z-10 relative">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 max-w-[1600px] mx-auto">
          {/* KPI Cards Row */}
          <div className="bg-surface-dark border border-white/5 rounded-2xl p-6 relative overflow-hidden group hover:border-primary/30 transition-all duration-300">
            ...
            <h3 className="text-slate-400 text-sm font-medium mb-1">Avg Sleep</h3>
            <p className="text-2xl font-bold text-white tracking-tight font-display">7h 12m</p>
          ...
          <div className="bg-surface-dark border border-white/5 rounded-2xl p-6 relative overflow-hidden group hover:border-primary/30 transition-all duration-300">
            ...
            <h3 className="text-slate-400 text-sm font-medium mb-1">Focus Score</h3>
            <p className="text-2xl font-bold text-white tracking-tight font-display">84<span className="text-slate-500 text-lg font-normal">/100</span></p>
          ...
          <div className="bg-surface-dark border border-white/5 rounded-2xl p-6 relative overflow-hidden group hover:border-primary/30 transition-all duration-300">
            ...
            <h3 className="text-slate-400 text-sm font-medium mb-1">Social Battery</h3>
            <p className="text-2xl font-bold text-white tracking-tight font-display">45%</p>
          ...
          <div className="bg-surface-dark border border-white/5 rounded-2xl p-6 relative overflow-hidden group hover:border-primary/30 transition-all duration-300">
            ...
            <h3 className="text-slate-400 text-sm font-medium mb-1">Caffeine</h3>
            <p className="text-2xl font-bold text-white tracking-tight font-display">120<span className="text-slate-500 text-lg font-normal">mg</span></p>
          ...
          <div className="lg:col-span-2 min-h-[400px] bg-surface-dark border border-white/5 rounded-2xl p-6 flex flex-col relative overflow-hidden">
            <div className="flex justify-between items-center mb-6 z-10">
              <div>
                <h3 className="text-white font-bold text-lg font-display">Balance Analysis</h3>
                <p className="text-slate-400 text-xs">Multi-variable correlation</p>
              </div>
            ...
            <div className="flex-1 flex items-center justify-center relative">
              <div className="relative w-64 h-64 flex items-center justify-center">
                ...
                <div className="absolute w-full h-px bg-white/5 top-1/2 left-0"></div>
                <div className="absolute h-full w-px bg-white/5 left-1/2 top-0"></div>
                <div className="absolute w-full h-px bg-white/5 top-1/2 left-0 rotate-45"></div>
                <div className="absolute h-full w-px bg-white/5 left-1/2 top-0 rotate-45"></div>
                ...
                <span className="absolute -top-6 text-xs text-slate-400 font-medium">Focus</span>
                <span className="absolute -bottom-6 text-xs text-slate-400 font-medium">Sleep</span>
                <span className="absolute -left-12 text-xs text-slate-400 font-medium">Caffeine</span>
                <span className="absolute -right-10 text-xs text-slate-400 font-medium">Social</span>
              </div>
            </div>
            <div className="flex gap-4 justify-center mt-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs text-slate-300">Average</span>
              </div>
            </div>
          </div>

          {/* Scatter Plot Container */}
          <div className="lg:col-span-2 min-h-[400px] bg-surface-dark border border-white/5 rounded-2xl p-6 flex flex-col">
            <div className="flex justify-between items-center mb-6">
              <div>
                <h3 className="text-white font-bold text-lg font-display">Productivity vs. Sleep</h3>
                <p className="text-slate-400 text-xs">Positive Correlation Detected</p>
              </div>
              <div className="flex gap-2">
                <span className="px-2 py-1 bg-surface-darker rounded border border-white/10 text-[10px] text-slate-400">R² = 0.82</span>
              </div>
            </div>
            <div className="flex-1 w-full relative pt-4 pl-4 pb-8 pr-2">
              <div className="h-full w-full border-l border-b border-white/10 relative">
                <div className="absolute w-full h-px bg-white/5 bottom-[25%]"></div>
                <div className="absolute w-full h-px bg-white/5 bottom-[50%]"></div>
                <div className="absolute w-full h-px bg-white/5 bottom-[75%]"></div>
                ...
                {/* Labels */}
                <div className="absolute -bottom-6 left-0 text-[10px] text-slate-500">4h</div>
                <div className="absolute -bottom-6 left-1/4 text-[10px] text-slate-500">6h</div>
                <div className="absolute -bottom-6 left-1/2 text-[10px] text-slate-500">8h</div>
                <div className="absolute -bottom-6 left-3/4 text-[10px] text-slate-500">10h</div>
                <div className="absolute -bottom-6 right-0 text-[10px] text-slate-500">12h</div>
              </div>
              <div className="absolute -left-6 top-1/2 -rotate-90 text-[10px] text-slate-500">Productivity Score</div>
            </div>
          </div>

          {/* Pie Chart / Time Distribution */}
          <div className="lg:col-span-1 min-h-[350px] bg-surface-dark border border-white/5 rounded-2xl p-6 flex flex-col">
            <h3 className="text-white font-bold text-lg mb-6 font-display">Time Distribution</h3>
            <div className="flex-1 flex flex-col items-center justify-center">
              <div className="relative w-40 h-40 mb-6">
                <svg className="w-full h-full -rotate-90" viewBox="0 0 36 36">
                  ...
                  <path className="text-slate-700" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" fill="none" stroke="currentColor" strokeDasharray="10, 100" strokeDashoffset="-92" strokeLinecap="round" strokeWidth="4"></path>
                </svg>
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                  <span className="text-2xl font-bold text-white font-display">6.5h</span>
                  <span className="text-[10px] text-slate-400">Deep Work</span>
                </div>
              </div>
          ...
          {/* AI Insights List */}
          <div className="lg:col-span-3 min-h-[350px] bg-surface-dark border border-white/5 rounded-2xl p-6 flex flex-col">
            <div className="flex justify-between items-center mb-6">
              <div className="flex items-center gap-3">
                <div className="p-2 rounded-lg bg-gradient-to-br from-primary/20 to-secondary/20 border border-white/5">
                  <Sparkles className="w-5 h-5 text-white" />
                </div>
                <div>
                  <h3 className="text-white font-bold text-lg font-display">AI Anomaly Detection</h3>
                  <p className="text-slate-400 text-xs">Based on last 24h biometrics</p>
                </div>
              </div>
              <button className="text-xs font-medium text-primary hover:text-primary/80 transition-colors">View All Analysis</button>
            </div>
            <div className="flex flex-col gap-3">
              <div className="flex items-start gap-4 p-4 rounded-xl bg-surface-darker border border-white/5 hover:border-primary/20 transition-all group">
                <div className="mt-1">
                  <div className="w-2 h-2 rounded-full bg-amber-500 shadow-[0_0_8px_#f59e0b]"></div>
                </div>
                <div className="flex-1">
                  <div className="flex justify-between items-center mb-1">
                    <h4 className="text-slate-200 text-sm font-medium group-hover:text-primary transition-colors">Caffeine Threshold Exceeded</h4>
              ...
              <div className="flex items-start gap-4 p-4 rounded-xl bg-surface-darker border border-white/5 hover:border-primary/20 transition-all group">
                ...
                <div className="flex-1">
                  <div className="flex justify-between items-center mb-1">
                    <h4 className="text-slate-200 text-sm font-medium group-hover:text-secondary transition-colors">Peak Focus Window Incoming</h4>
